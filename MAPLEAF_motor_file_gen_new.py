...
outputFileName = r'C:\Users\taiya\anaconda3\envs\SOAR\Lib\site-packages\MAPLEAF\Examples\Motors\HyEnd120000.txt' #.txt file with the name you want to call the motor file

extend = True
write = True
extension = -1 #seconds
estimation = True
estimationAvgThrust = 12500 #from NASA CEA + Reynolds transport theorem or other calculations
oxidizer_flowrate = 5 #Hardcoded because the data is being weird. Likely because of the time difference
OFRatio = 7.2
