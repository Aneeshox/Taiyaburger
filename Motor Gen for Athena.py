...
file_name = r'C:\Users\taiya\anaconda3\envs\SOAR\Lib\site-packages\MAPLEAF\Aneeshox work\StaticFireData.txt' #Input file name
outputFileName = r'C:\Users\taiya\anaconda3\envs\SOAR\Lib\site-packages\MAPLEAF\Examples\Motors\Athena2.txt' #.txt file with the name you want to call the motor file

extend = True
write = True
extension = 7 #seconds % 
estimation = True
estimationAvgThrust = 11500 #from NASA CEA + Reynolds transport theorem or other calculations
oxidizer_flowrate = 3.36364 #Hardcoded because the data is being weird. Likely because of the time difference
OFRatio = 7.2
