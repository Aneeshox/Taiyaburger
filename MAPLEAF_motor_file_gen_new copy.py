...
file_name = r'C:\Users\taiya\anaconda3\envs\SOAR\Lib\site-packages\MAPLEAF\Aneeshox\StaticFireData.txt' #Input file name
outputFileName = r'C:\Users\taiya\anaconda3\envs\SOAR\Lib\site-packages\MAPLEAF\Examples\Motors\OUROOOOTEST.txt' #.txt file with the name you want to call the motor file

extend = True
write = True
extension = 0.5 #seconds % 
estimation = True
estimationAvgThrust = 4500 #from NASA CEA + Reynolds transport theorem or other calculations
oxidizer_flowrate =  1.96 #Hardcoded because the data is being weird. Likely because of the time difference
OFRatio =  7.65
...
diamOfPressureVessel = 0.223
lengthOfPressureVessel = 4

lenghtOfFuelGrain = 1.3
outerDiamFuelGrain = 0.223
innerDiamFuelGrain = 0.10
